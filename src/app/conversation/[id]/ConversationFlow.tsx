    ...
    return (
      <div className="text-center py-12 text-gray-500">
        ...
        <p className="text-sm mt-2">
          In MVP mode, a live conversation would be generated here.
        </p>
      </div>
    )
  }
  ...
  return (
    <div>
      ...
      <div className="mt-8 flex justify-center gap-2">
        {(['phase1', 'phase2', 'phase3', 'synthesis'] as FlowPhase[]).map((phase, i) => (
          <div
            key={phase}
            className={`w-2 h-2 rounded-full transition-colors ${
              currentPhase === phase
                ? 'bg-green-600'
                : i < ['phase1', 'phase2', 'phase3', 'synthesis'].indexOf(currentPhase)
                ? 'bg-green-300'
                : 'bg-gray-200'
            }`}
          />
