    ...
    <main className="max-w-3xl mx-auto px-6 py-10 text-gray-800">
      ...
      <div className="mb-8 pb-6 border-b border-gray-200">
        ...
        <p className="text-sm text-gray-600 mb-4">
          ...
          and will eventually be administered directly by NLU. This page
          walks you through registering it as an LTI 1.3 tool in Brightspace.
          Work through each step, clicking{' '}
        ...
        <div className="flex flex-wrap gap-x-6 gap-y-1 text-xs text-gray-600">
          ...
          <div>
            <span className="font-semibold">Ends with:</span> emailing back 4 values
          </div>
        </div>
      </div>
      ...
      <Step number={7} title="Quick verification test" time="5 min">
        ...
        <ol className="text-sm list-decimal ml-5 space-y-1 text-gray-700">
          ...
          <li>
            Within ~30 seconds the portfolio should receive the submission
            — let us know and we can confirm on the portfolio side.
          </li>
        </ol>
      </Step>

      {/* ─── Step 8 ──────────────────────────────── */}
      <Step number={8} title="Send back four values" time="2 min">
        <p className="text-sm mb-4 text-gray-600">
          Email the following to the email address shown on the button below.
          Until these four values are set on our side, the integration cannot
          go live.
        </p>
      ...
      <section className="mb-10">
        ...
        <p className="text-xs text-gray-500 mt-3">
          Email the error message or a screenshot to the contact address in
          Step 8 and we&rsquo;ll diagnose together.
        </p>
      </section>
